...
try:
    ...
    if df is not None:
        ...
        if st.session_state.calc_history:
            ...
            st.markdown("---")
            st.link_button("🔗 หลักเกณฑ์การคำนวณราคากลางงานก่อสร้างชลประทาน ปรับปรุงตามประกาศฯ ฉบับที่ 5 บังคับใช้ 2 สิงหาคม 2565") 
            ("และ ว1288 ลว. 17 ตุลาคม 2565 อัตรา ดอกเบี้ยเงินกู้ 6%"), "https://drive.google.com/file/d/1tCep-NffAYB2QtDaPo7b2RwTuy7O_aw8/view", use_container_width=True)
    else:

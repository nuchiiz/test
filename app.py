...
# CSS สำหรับ UI: หัวข้อชิดซ้าย / ตารางตรงกลาง / ปรับช่อง Input ให้อยู่ระดับเดียวกัน
st.markdown("""
    <style>
    ...
    /* 2. จัดการตำแหน่งปุ่มให้อยู่ระดับเดียวกับช่องกรอก (Alignment Fix) */
    div.stButton > button {
        margin-top: 28px !important; /* ดันปุ่มลงมาให้ตรงกับแนว input */
    }
...
try:
    ...
    if df is not None:
        ...
        # 2. รายการงาน (จัดระดับให้อยู่แนวเดียวกัน)
        st.markdown("### ➕ 2. รายการงานก่อสร้าง")
        col_in1, col_in2, col_in3 = st.columns([2.5, 1, 1]) # ปรับอัตราส่วนคอลัมน์ให้กว้างขึ้น
        ...
        # ปุ่ม "เพิ่มรายการ" จะถูก CSS ดันลงมาให้อยู่ระดับเดียวกับช่องกรอกโดยอัตโนมัติ

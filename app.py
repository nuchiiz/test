...
try:
    ...
    if df is not None:
        ...
        with st.expander("📝 ปริมาณวัสดุที่ได้รับอนุมัติตามแผน", expanded=True):
            ...
            p_names = ["หินใหญ่", "หินย่อย", "ทรายหยาบ", "ปูนซีเมนต์", "หินคลุก", "เหล็กเสริมเสริมคอนกรีต", "ลวดผูกเหล็กเสริม"]
            planned_values = {}
        ...
        if col_in3.button("➕ เพิ่มรายการ", use_container_width=True):
            if q_val is not None and q_val > 0:
                ...
                # แมป Column ตามไฟล์ CSV (หินใหญ่:2, หินย่อย:4, ทรายหยาบ:6, ปูนซีเมนต์:8, หินคลุก:10, เหล็กเสริมเสริมคอนกรีต:12, ลวดผูกเหล็กเเสริม:14)
                m_map = {"หินใหญ่": 2, "หินย่อย": 4, "ทรายหยาบ": 6, "ปูนซีเมนต์": 8, "หินคลุก": 10, "เหล็กเสริมเสริมคอนกรีต": 12, "ลวดผูกเหล็กเเสริม": 14}
                temp_details = {}

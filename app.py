...
try:
    ...
    if df is not None:
        ...
        # 1. ตั้งค่าแผนงาน (Planned) - ปรับให้เป็นช่องว่าง (None) เพื่อให้กรอกจำนวนได้ทันที
        ...
        q_val = col_in2.number_input("ปริมาณงานที่ทำ:", min_value=0.0, value=None, placeholder="กรอกจำนวน...")
